...
if __name__ == '__main__':
    import pickle
    import sys
    path = sys.argv[1] if len(sys.argv) > 1 else 'data_maestro/maestro-v3.0.0/2004/MIDI-Unprocessed_SMF_02_R1_2004_01-05_ORIG_MID--AUDIO_02_R1_2004_05_Track05_wav.midi'

    print('Converting MIDI to EventSeq')
    es = EventSeq.from_note_seq(NoteSeq.from_midi_file(path))
    print(np.asarray(es.to_array()).shape)
